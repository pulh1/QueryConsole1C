...
Функция Описание() Экспорт
	...
	Описание.Подсказка = "Обеспечивает доступ к методу ""КадровыйУчет.СоздатьВТСотрудникиОрганизации"".
	|Позволяет получить сотрудников организации работающих на определенную дату или в течении периода (в зависимости от параметров). 
	|Могут учитываться как сотрудники по трудовым договорам так и сотрудники по договорам ГПХ.
	|Кроме самих сотрудников можно получить также их данные (подразделение, ФОТ и т.п.)";
