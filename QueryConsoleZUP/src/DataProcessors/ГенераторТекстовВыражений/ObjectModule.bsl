...
Процедура ВыражениеВМассивСтрок(Выражение, Знач Табуляции, Родитель = Неопределено) Экспорт
	...
	ИначеЕсли Выражение.Тип = "БинарнаяОперация" Тогда
		...
		ВыражениеВМассивСтрок(Выражение.ЛеваяЧасть, Табуляции + Символы.Таб, Выражение);
		ТекущиеТабуляции = Табуляции;
		Если Выражение.Операция = "И"
			Или Выражение.Операция = "ИЛИ" Тогда
		...
		МассивСтрок.Добавить(" ");
		ВыражениеВМассивСтрок(Выражение.ПраваяЧасть, Табуляции + Символы.Таб, Выражение);
...
Процедура СписокВыраженийВВМассивСтрок(СписокВыражений, Табуляции) Экспорт
	...
	Для Каждого Выражение Из СписокВыражений.Элементы Цикл
