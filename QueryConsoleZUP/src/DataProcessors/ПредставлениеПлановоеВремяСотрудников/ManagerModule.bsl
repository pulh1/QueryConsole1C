...
Функция Описание() Экспорт
	...
	Описание.ПоддерживаютсяИндексы = Ложь;
	Описание.Подсказка = "Обеспечивает доступ к методу ""УчетРабочегоВремениРасширенный.СоздатьВТПлановоеВремя"".
...
Функция ИсполняемыйКод(ПараметрыВыполнения, ТекущиеТаблцляции) Экспорт
	...
	ТекстовыйДокумент.ДобавитьСтроку(ТекущиеТаблцляции + "УчетРабочегоВремениРасширенный.СоздатьВТПлановоеВремя(");
