...
Процедура СценарийСозданияОператораЗапросаВыбораВТекДок(МодельОператораЗапроса, Знач ТекущиеТабуляции = "")
	ВсеИсточники = МодельЗапросаУтилиты.ВсеИсточникиОператора(МодельОператораЗапроса);
	ГенераторТекстовВыражений.УстановитьИсточники(ВсеИсточники);
	...
	ИсточникиЗапросаВТекстовыйДокумент(ВсеИсточники, ТекущиеТабуляции);
...
Процедура СоединенияИсточникаВТекДок(Источник, ИсточникиПоИдентификаторам, Знач ТекущиеТабуляции = "")
	Для Каждого Соединение Из Источник.Соединения Цикл
		...
		ПрисоединяемаяТаблица = Соединение.Источник.Источник.Псевдоним;
