...
Функция Описание(ИмяРегистра) Экспорт
	...
	Описание.ОписаниеОтбора = ПредставленияРегистровСведенийЗУПУтилиты.ОписаниеОтбораИсполняемогоПредставления(МетаданныеРегистра);
...
Функция Справка() Экспорт
	...
	Справка.Имя = "ИсполняемоеПредставление.РегистрСведений.ИмяРегистра.Периоды";
	Справка.Описание = "Обеспечивает доступ к методу ""ЗарплатаКадрыПериодическиеРегистры.СоздатьВТИмяРегистраПериоды"".
...
Функция ИмяПредставления() Экспорт
	Возврат "РегистрСведений.Периоды";
КонецФункции
...
Функция ТекстЗапросаДляСКД(ПараметрыВыполнения) Экспорт
	ЧастиИмени = СтрРазделить(ПараметрыВыполнения.ИмяИсполняемогоПредставления, ".");
	ИмяРегистра = ЧастиИмени[ЧастиИмени.ВГраница() - 1];
	ВызватьИсключение "Для представления " + ИмяПредставления() + " не поддерживается генерация кода запроса для СКД.";
КонецФункции
