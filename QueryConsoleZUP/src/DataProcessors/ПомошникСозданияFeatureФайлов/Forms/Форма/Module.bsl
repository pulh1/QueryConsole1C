...
&НаКлиенте
Функция FeatureФайлПроверкиРезультатаЗапрсаВКонсоли(ИмяЗапроса, ИмяФалаЗапроса, ИмяФайлаЭталона)
	Текст = "Функционал: Выполнение запроса """ + ИмяЗапроса + """ в косоли
	|
	...
	|	И Я открываю файл """ + ИмяФалаЗапроса + """ запроса в консоли
