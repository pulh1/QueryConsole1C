...
&НаКлиенте
Процедура СоединенияПриАктивизацииСтроки(Элемент)
	СоединениеТаблицТекст = "";
	Если ИдентифкаторСтрокиПрисоединяемойТаблицы = Неопределено 
		Или Элементы.Соединения.ТекущаяСтрока = Неопределено Тогда
		Возврат;
	КонецЕсли;	
	
	Если Не ЗначениеЗаполнено(Элементы.Соединения.ТекущиеДанные.Таблица)
		Или ИдентифкаторСтрокиПрисоединяемойТаблицы = Элементы.Соединения.ТекущаяСтрока Тогда
			
		Возврат
	КонецЕсли;
	
	СтрокаПрисоединяемойТаблицы = Соединения.НайтиПоИдентификатору(ИдентифкаторСтрокиПрисоединяемойТаблицы);
...
Процедура СоединитьТаблицы(Команда)
	ИдентифкаторСтрокиПрисоединяемойТаблицы = Неопределено;
	Если Элементы.Соединения.ТекущаяСтрока = Неопределено 
		...
		Возврат;
	КонецЕсли; 
	ИдентифкаторСтрокиПрисоединяемойТаблицы = Элементы.Соединения.ТекущаяСтрока;
	СоединениеТаблицТекст = Нстр("ru='Укажите, с каким источником создать связь'");
КонецПроцедуры
