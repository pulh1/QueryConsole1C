...
Функция ИсполняемыйКод(ПараметрыВыполнения, ТекущиеТаблцляции) Экспорт
	...
	Строка = ГенерацияИсполняемогоКодаПредставленийУтилиты.СтрокаПрисовенияЗначения("ОписаниеФильтра.ИмяВТКадровыеДанныеСотрудников", ПараметрыВыполнения.ИмяВТРезультат);
	ТекстовыйДокумент.ДобавитьСтроку(ТекущиеТаблцляции + Строка);
	
	Строка = ГенерацияИсполняемогоКодаПредставленийУтилиты.СтрокаПрисовенияЗначения("ТолькоРазрешенные", ПараметрыВыполнения.ТолькоРазрешенные);
	ТекстовыйДокумент.ДобавитьСтроку(ТекущиеТаблцляции + Строка);
