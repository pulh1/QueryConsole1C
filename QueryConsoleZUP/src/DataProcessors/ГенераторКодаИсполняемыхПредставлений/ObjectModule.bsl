...
Процедура ВывестиТекущийПакетЗапросов(Знач Табуляции, ДобавитьВозврат = Ложь)
	...
	Если ДобавитьВозврат Тогда
		ТекстовыйДокумент.ДобавитьСтроку(Табуляции + "Возврат Запрос.Выполнить();");		
	Иначе
		ТекстовыйДокумент.ДобавитьСтроку(Табуляции + "Запрос.Выполнить();");
	КонецЕсли;
КонецПроцедуры
