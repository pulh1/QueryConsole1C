...
Процедура СписокВыраженийУпорядочиванияВМассивСтрок(ВыраженияУпорядовачивания, Знач Табуляции) Экспорт
	...
	Для Каждого ЭлементУпорядовачивания Из ВыраженияУпорядовачивания Цикл
		...
		ВыражениеВМассивСтрок(ЭлементУпорядовачивания.Выражение, Табуляции);

		Если ЭлементУпорядовачивания.Иерархия Тогда
			МассивСтрок.Добавить(" ИЕРАРХИЯ");
		КонецЕсли;
		
		Если ЭлементУпорядовачивания.Направление = "Убыв" Тогда
