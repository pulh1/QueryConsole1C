...
Процедура ПосетитьВложенныйЗапрос(УзелЗапроса) Экспорт
	...
	ОбработкаМоделиЗапроса.ОбработатьЗапрос(УзелЗапроса, ВложенныйКонтекст);
...
Процедура ПриведениеТипаПриВыходе(Выражение) Экспорт	
	ЦелевойТип = ИзвлечьЭлементИзСтэка();
	ИзвлечьЭлементИзСтэка();
...
Процедура ТипСсылочногоПоляПриВыходе(Выражение) Экспорт
	ТипЗначения = СемантическийАнализВыраженийУтилиты.ТипСсылочногоПоля(Выражение);
	СтэкТипов.Добавить(ТипЗначения);
КонецПроцедуры
...
Процедура ФункцияЗначениеПриВыходе(Выражение) Экспорт
	ТипЗначения = СемантическийАнализВыраженийУтилиты.ТипФункцииЗначение(Выражение);
	СтэкТипов.Добавить(ТипЗначения);
КонецПроцедуры
