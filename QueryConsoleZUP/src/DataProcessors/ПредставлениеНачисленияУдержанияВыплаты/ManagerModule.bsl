...
Функция Описание() Экспорт
	...
	Описание.ИмяВТДляСКД = "ОбщиеЗапросы_НачисленияУдержания";  
	Описание.ПоддерживаютсяИндексы = Ложь; 
	...
	Поле.ТипЗначения = Метаданные.РегистрыНакопления.НачисленияУдержанияПоСотрудникам.Реквизиты.ДокументОснование.Тип;
	Описание.Поля.Добавить(Поле);
	...
	Описание.ОписаниеПараметров.Добавить(Параметр);
	Параметр.Обязательный = Ложь;
	Параметр.Имя = "ДетализироватьНачисленияПоСреднемуЗаработку"; 
	Параметр.ДопустимПараметрЗапроса = Ложь;
	Параметр.ТипКонстанты = Новый ОписаниеТипов("Булево");
	Параметр.ЗначениеПоУмолчанию = Ложь;
...
Функция Справка() Экспорт
	...
	Справка.Описание = 
		"Обеспечивает доступ к результату запроса, используемого в типовом отчете ""Анализ начислений и удержаний””.
		|Предоставляет информацию о начисления, удержаниях, выплатах и сальдо взаиморасчетов.";
	
	Возврат Справка;
КонецФункции

Функция ИмяПредставления() Экспорт
	Возврат "ИсполняемоеПредставление.НачисленияУдержанияВыплаты";
КонецФункции
...
Функция Исполнить(ПараметрыВыполнения, Запрос) Экспорт
	...
	ДетализироватьНачисленияПоСреднемуЗаработку = ИсполнительПредставленийУтилиты.ЗначениеПараметраКонстанты(
...
Функция ТекстЗапросаДляСКД(ПараметрыВыполнения) Экспорт
	Описание = ПоставщикИсполняемыхПредставлений.ОписаниеПредставленияПоИмени(
		ПараметрыВыполнения.ИмяИсполняемогоПредставления);
