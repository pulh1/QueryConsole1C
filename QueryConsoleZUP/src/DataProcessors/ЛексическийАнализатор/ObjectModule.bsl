...
Перем НомерСимволаВСтроке;
Перем НомерСимволаНачалоТокена;
...
Функция Токен()
	...
	Токен.НомерСимвола = НомерСимволаВСтроке; 
...
Функция ТокенЛексема(Лексема)
	...
	Токен.НомерСимвола = НомерСимволаНачалоТокена;
...
Функция ТокенСтроковаяКонстанта(Значение)
	...
	ТокенКонстанта.НомерСимвола = НомерСимволаНачалоТокена;
...
Функция ТокенСлово(Лексема)
	...
	ТокенСлово.НомерСимвола = НомерСимволаНачалоТокена;
...
Процедура УстановитьОбрабатываемыйСимвол()	
	...
	НомерСимволаВСтроке = НомерСимволаВСтроке + 1;
...
Функция СледующийТокен() Экспорт
	...
	НомерСимволаНачалоТокена = НомерСимволаВСтроке;
	...
	ИначеЕсли ЭтоКонстанта() Тогда
		Константа = КонстантаИзСтроки();
		
		Если Константа.Тип = Тип("Число") Тогда
			Токен = ТокенЧисловаяКонстанта(Константа.Значение);
		Иначе
			Токен = ТокенСтроковаяКонстанта(Константа.Значение);
		КонецЕсли;	
