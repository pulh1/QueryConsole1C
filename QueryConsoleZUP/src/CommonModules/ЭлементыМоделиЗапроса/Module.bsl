...
// * Источники - см. НовыйИсточникиЗапроса
...
// Новый источники запроса.
// 
// Параметры:
//  ТекущийТокен - Неопределено - Текущий токен
// 
// Возвращаемое значение:
//  Структура - Новый источники запроса:
// * Элементы - Массив из см. НовыйИсточник
Функция НовыйИсточникиЗапроса(ТекущийТокен = Неопределено) Экспорт
	ЭлементМодели = НовыйЭлементМоделиЗапроса("ИсточникиЗапроса", ТекущийТокен);
	ЭлементМодели.Вставить("Элементы", Новый Массив());
