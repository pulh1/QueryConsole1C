...
Функция НовыйВыражиениеВсеПоля(ТекущийТокен = Неопределено) Экспорт
	ЭлементМодели = НовыйЭлементМоделиЗапроса("ВыражиениеВсеПоля", ТекущийТокен);
	Возврат ЭлементМодели;
КонецФункции

Функция НовыйВыражиениеВсеПоляИсточника(ТекущийТокен = Неопределено) Экспорт
	ЭлементМодели = НовыйЭлементМоделиЗапроса("ВыражиениеВсеПоляИсточника", ТекущийТокен);
	Возврат ЭлементМодели;
КонецФункции
