...
Процедура ОбойтиДерево(Узел, Посетитель) Экспорт
	...
	ИначеЕсли ТипУзла = "ТипСсылочногоПоля" Тогда
		ОбработатьТипСсылочногоПоля(Узел, Посетитель);
	ИначеЕсли ТипУзла = "ОписаниеТипаБулево" Тогда
		ОбработатьОписаниеТипаБулево(Узел, Посетитель);
	ИначеЕсли ТипУзла = "ОписаниеТипаДата" Тогда
		ОбработатьОписаниеТипаДата(Узел, Посетитель);
	ИначеЕсли ТипУзла = "ОписаниеТипаЧисло" Тогда
		ОбработатьОписаниеТипаЧисло(Узел, Посетитель);
	ИначеЕсли ТипУзла = "ОписаниеТипаСтрока" Тогда
		ОбработатьОписаниеТипаСтрока(Узел, Посетитель);
...
Процедура ОбработатьРазыменование(Узел, Посетитель)
	Посетитель.РазыменованиеПриВходе(Узел);
...
Процедура ОбработатьТипСсылочногоПоля(Узел, Посетитель)
	Посетитель.ТипСсылочногоПоляПриВходе(Узел);
	Посетитель.ТипСсылочногоПоляПриВыходе(Узел);
КонецПроцедуры

Процедура ОбработатьОписаниеТипаБулево(Узел, Посетитель)
	Посетитель.ОписаниеТипаБулевоПриВходе(Узел);
	Посетитель.ОписаниеТипаБулевоПриВыходе(Узел);
КонецПроцедуры

Процедура ОбработатьОписаниеТипаДата(Узел, Посетитель)
	Посетитель.ОписаниеТипаДатаПриВходе(Узел);
	Посетитель.ОписаниеТипаДатаПриВыходе(Узел);
КонецПроцедуры

Процедура ОбработатьОписаниеТипаЧисло(Узел, Посетитель)
	Посетитель.ОписаниеТипаЧислоПриВходе(Узел);
	Посетитель.ОписаниеТипаЧислоПриВыходе(Узел);
КонецПроцедуры

Процедура ОбработатьОписаниеТипаСтрока(Узел, Посетитель)
	Посетитель.ОписаниеТипаСтрокаПриВходе(Узел);
	Посетитель.ОписаниеТипаСтрокаПриВыходе(Узел);
КонецПроцедуры
...
Процедура ОбработатьФункциюДатаВремя(Узел, Посетитель)
	Посетитель.ФункцияДатаВремяПриВходе(Узел);
...
Процедура ОбработатьФункциюЗначение(Узел, Посетитель)
	Посетитель.ФункцияЗначениеПриВходе(Узел);
...
Процедура ОбработатьВыражениеВсеПоля(Узел, Посетитель)
	Посетитель.ВыражениеВсеПоляПриВходе(Узел);
