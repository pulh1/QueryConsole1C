...
// * ДоступныеПоля - Массив - 
// * ПоддерживаемыеОперации - Структура - :
// ** ИЛИ - Булево - 
// ** Сравнение - Булево - 
// ** ВСписок - Булево - 
// ** МЕЖДУ - Булево - 
...
Функция НовыйОписаниеОтбора() Экспорт
    ...
    ПоддерживаемыеОперации.Вставить("ИЛИ", Истина); 
    ПоддерживаемыеОперации.Вставить("Сравнение", Истина);      // =, <>, >, <, >=, <=
    ПоддерживаемыеОперации.Вставить("ВСписок", Истина);        // В (...), НЕ В (...), 
    ПоддерживаемыеОперации.Вставить("МЕЖДУ", Истина);          // МЕЖДУ ... И ...
    ПоддерживаемыеОперации.Вставить("ПОДОБНО", Ложь);          // Не для всех полей
    ПоддерживаемыеОперации.Вставить("ВИерархии", Истина);      // В ИЕРАРХИИ
    ПоддерживаемыеОперации.Вставить("ВложенныйЗапрос", Истина); // В (ВЫБРАТЬ...)
    ПоддерживаемыеОперации.Вставить("СписокПолей", Истина); // (Поле1, Поле2..) В (ВЫБРАТЬ...) или (Поле1, Поле2..) В (&ПараметрТаблицаЗначений...)
    ПоддерживаемыеОперации.Вставить("РазыменованиеПолей", Истина); 
    ПоддерживаемыеОперации.Вставить("ЯзыкВыражений", Истина); // можно использовать операции +, -, операторы КОГДА и функции языка запрсов  т.п.
