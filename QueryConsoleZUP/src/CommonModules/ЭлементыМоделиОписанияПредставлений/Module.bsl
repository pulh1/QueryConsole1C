...
// * Поля - Массив из см. НовыйПолеПредставления - доступные поля -
// * ОписаниеВТФильтр - см. НовыйОписаниеВТФильтр - описание временной таблицы-фильтра
...
Функция НовыйОписаниеПредставления() Экспорт                                        
	...
	ОписаниеПредставления.Вставить("УдалятьПромежуточныеВТ", Ложь);
