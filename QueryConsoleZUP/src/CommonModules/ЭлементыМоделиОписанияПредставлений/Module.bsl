...
Функция НовыйОписаниеОтбора() Экспорт
    ...
    ОписаниеОтбора.Вставить("АвтоматическиОптимизировать", Истина);
    ...
    ПоддерживаемыеОперации.Вставить("ВСписок", Истина);        // В (...)
    ...
    // Ограничения
    ОписаниеОтбора.Вставить("МаксимальнаяГлубинаРазыменования", 2);  // Контрагент.Регион.Страна
    ОписаниеОтбора.Вставить("МаксимальнаяСложностьВыражения", 10);   // Количество операций
