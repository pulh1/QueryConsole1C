...
Функция ОписаниеПолейКадровыхДанныхСотрудниоков() Экспорт
	Поля = Новый Массив();
...
//	ЗарплатаКадрыКорпоративнаяПодсистемы.ИспытательныйСрокСотрудников
	...
	Поле.ТипЗначения = Новый ОписаниеТипов("Булево");
	Поле.ДоступноПриНаличииПодсистемы = "арплатаКадрыКорпоративнаяПодсистемы.ИспытательныйСрокСотрудников";
	Поля.Добавить(Поле);
