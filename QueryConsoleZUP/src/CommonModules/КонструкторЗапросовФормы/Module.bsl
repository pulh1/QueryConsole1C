...
// Возвращает полное нейтральное описание таблицы для редактора параметров.
//
// Параметры:
//  ИмяТаблицы - Строка - Полное имя таблицы.
//  КонтекстМетаданныхUI - Структура - Контекст с реестром поставщиков.
//
// Возвращаемое значение:
//  Структура, Неопределено - Описание таблицы.
...
// Отбирает нейтральные параметры указанного вида.
//
// Параметры:
//  Параметры - Массив из Структура - Описания параметров.
//  ВидПараметра - Строка - Искомый вид параметра.
//
// Возвращаемое значение:
//  Массив из Структура - Параметры указанного вида.
...
Функция ОписанияКорневыхСтрокКаталога(КонтекстМетаданныхUI) Экспорт
	...
	ЭлементыКаталога =
		КонтекстМетаданныхUI.Реестр.КорневыеЭлементыКаталога();
...
// Заполняет корень дерева ленивого каталога зарегистрированных поставщиков.
//
// Параметры:
...
Функция ОписанияДочернихСтрокКаталога(
	...
	ЭлементыКаталога =
		КонтекстМетаданныхUI.Реестр.ДочерниеЭлементыКаталога(
