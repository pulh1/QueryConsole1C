...
Функция СодержитТип(ТипЭлемента, ЦелевойТип) Экспорт 
...
Функция ЭтоПоле(СтрокаТаблицы) Экспорт 
	Если КонструкторЗапросовКлиентСерверФормы.СодержитТип(СтрокаТаблицы.ТипЗначения, "ДоступноеПолеТаблицы") Тогда   
		Возврат Истина;
	ИначеЕсли КонструкторЗапросовКлиентСерверФормы.СодержитТип(СтрокаТаблицы.ТипЗначения, "ПолеПредставления") Тогда    	
		Возврат Истина;
	ИначеЕсли КонструкторЗапросовКлиентСерверФормы.СодержитТип(СтрокаТаблицы.ТипЗначения, "ПолеВложеннойТаблицы") Тогда     	
		Возврат Истина;
	Иначе 
		Возврат Ложь;		
	КонецЕсли;		
...
Функция ЭтоИсточникЗапроса(СтрокаТаблицы, ДопустимыВложенныеТаблицы = Истина) Экспорт 
	Если КонструкторЗапросовКлиентСерверФормы.СодержитТип(СтрокаТаблицы.ТипЗначения, "ИсточникДанныхТаблица") Тогда
		Возврат Истина;
	ИначеЕсли  КонструкторЗапросовКлиентСерверФормы.СодержитТип(СтрокаТаблицы.ТипЗначения, "ИсточникДанныхВложенныйЗапрос") Тогда   	
		Возврат Истина; 
	ИначеЕсли  КонструкторЗапросовКлиентСерверФормы.СодержитТип(СтрокаТаблицы.ТипЗначения, "ДоступнаяВложеннаяТаблицаСхемыЗапроса") 
		И ДопустимыВложенныеТаблицы Тогда   
		Возврат Истина;	
	ИначеЕсли  КонструкторЗапросовКлиентСерверФормы.СодержитТип(СтрокаТаблицы.ТипЗначения, "ИсточникДанныхВременнаяТаблица") Тогда    	
		Возврат Истина;
	ИначеЕсли  КонструкторЗапросовКлиентСерверФормы.СодержитТип(СтрокаТаблицы.ТипЗначения, "ИсточникДанныхТаблицаЗначений") Тогда     	
		Возврат Истина; 
	ИначеЕсли  КонструкторЗапросовКлиентСерверФормы.СодержитТип(СтрокаТаблицы.ТипЗначения, "ИсполняемоеПредставление") Тогда     	
		Возврат Истина;
	Иначе 
		Возврат Ложь;		
	КонецЕсли;		
