...
Функция НайтиПолеВоВсехИсточниках(ИмяПоля, Контекст) 
	...
	НайденныйИсточника = Неопределено;
...
Функция НайтиПолеВИсточнике(ИмяПоля, Источник, Контекст) Экспорт 
	...
	ИначеЕсли Источник.Тип = "ИсточникДанныхТаблица" Тогда 		
		ОписаниеТаблицыПоставщика = ОписаниеТаблицыИзРеестра(Источник.ИмяТаблицы, Контекст);
		Если ОписаниеТаблицыПоставщика <> Неопределено Тогда
			ДоступноеПоле = НайтиПолеВПоляхПоставщика(ОписаниеТаблицыПоставщика.Поля, ИмяПоля);
...
Функция ТипПоляПоИмени(ИмяПоля, Источник, Контекст) Экспорт
	...
	ИначеЕсли Источник.Тип = "ИсточникДанныхВременнаяТаблица" Тогда	 
		Если Источник.ОписаниеВТ <> Неопределено
			И Контекст.ЗаполнятьОписаниеВременныхТаблиц
...
Функция ОписаниеТаблицыИзРеестра(ИмяТаблицы, Контекст)
	РеестрПоставщиковМетаданныхТаблиц = Неопределено;
	Если Контекст.Свойство("РеестрПоставщиковМетаданныхТаблиц", РеестрПоставщиковМетаданныхТаблиц)
		И РеестрПоставщиковМетаданныхТаблиц <> Неопределено Тогда
		
		Возврат Контекст.РеестрПоставщиковМетаданныхТаблиц.ОписаниеТаблицы(ИмяТаблицы);
	КонецЕсли;
	
	Возврат Неопределено;
КонецФункции

Функция НайтиПолеВПоляхПоставщика(Поля, ИмяПоля)
