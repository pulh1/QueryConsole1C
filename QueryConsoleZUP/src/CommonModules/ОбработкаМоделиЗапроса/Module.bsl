...
Функция КонтекстОбработкиВыражения(РеестрПоставщиков = Неопределено) Экспорт
	...
	Контекст.Вставить(
		"ДоступныеТаблицыИБ",
		ВспомогательнаяСхема.ПакетЗапросов.Добавить(Тип("ЗапросВыбораСхемыЗапроса")).ДоступныеТаблицы);
...
Функция КонтекстОбработкиЗапроса(РеестрПоставщиков = Неопределено) Экспорт
	Контекст = КонтекстОбработкиВыражения(РеестрПоставщиков);
...
Функция КонтекстОбработкиВложенногоЗапроса(ТекущийКонтекст, ДоступныИсточникиВнешнегоЗапроса = Ложь) Экспорт  
	Контекст = КонтекстОбработкиЗапроса(ТекущийКонтекст.РеестрПоставщиковМетаданныхТаблиц);
