...
Процедура ОбработатьИсточникЗапроса(Источник, Контекст) Экспорт 
	...
	Для Каждого Параметр Из Параметры Цикл
		...
		ИначеЕсли ЭтоПараметрОтбор(Параметр.Значение) Тогда 
			Отбор = ОбработатьПараметрОтбор(ИсполняемоеПредставление, Параметр);
...
Процедура УстановитьПараметрыИсполняемогоПредставления(ИсполняемоеПредставление, ОписаниеПредставления, Параметры, ОписаниеДоступныхВТ) Экспорт
	...
	Для Каждого ТекущийПараметр Из Параметры Цикл
		...
		ИначеЕсли ТекущийПараметр.Тип = "ОтборИсполняемогоПредставления" Тогда 
			ПроверитьОтбор(ТекущийПараметр, ИсполняемоеПредставление, ОписаниеПредставления, ОписаниеДоступныхВТ);
...
Функция ОбработатьПараметрОтбор(ИсполняемоеПредставление, Параметр)
...
Процедура ПроверитьОтбор(Отбор, ИсполняемоеПредставление, ОписаниеПредставления, ОписаниеДоступныхВТ) 		
	...
	КонтекстОбработкиОтбора = КонтекстОбработкиОтбора(ИсполняемоеПредставление, ИдентификаторИсточника, ОписаниеДоступныхВТ);		
...
Функция КонтекстОбработкиОтбора(ИсполняемоеПредставление, ИдентификаторИсточника, ОписаниеДоступныхВТ) Экспорт  
	...
	Источник.ИдентификаторИсточника = ИдентификаторИсточника;
	Источник.Источник = ИсполняемоеПредставление;
