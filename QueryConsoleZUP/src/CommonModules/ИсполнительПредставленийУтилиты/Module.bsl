...
Процедура УстановитьЗначениеПараметра(СтруктураПраметров, ПараметрыВыполнения, ПараметрыЗапроса, ИмяПараметра, Знач ИмяПараметраВыполнения = Неопределено) Экспорт
	...
	Если ЗначениеПараметра <> Неопределено Тогда
		СтруктураПраметров[ИмяПараметра] = ЗначениеПараметра;	
	КонецЕсли;	
КонецПроцедуры

Процедура УстановитьЗначениеПараметров(СтруктураПраметров, ПараметрыВыполнения, ПараметрыЗапроса, УстанавливаемыеПараметры) Экспорт
...
Функция ЗначениеПараметраКонстанты(ИмяПараметра, ПараметрыВыполнения, ПараметрыЗапроса, ЗначениеПоУмолчанию = Неопределено) Экспорт
