...
//	ФинальныйЗапрос = МодельЗапроса.Элементы[МодельЗапроса.Элементы.ВГраница()];
	
	ТекстЗапроса = УниверсальныйОтчетРасширенный.ЗаменитьИсполняемыеПредставленияВременнымиТаблицами(МодельЗапроса);
