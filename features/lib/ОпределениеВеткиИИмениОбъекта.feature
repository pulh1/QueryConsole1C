		...
		Иначе
			Для Индекс = 1 По ЧастиИмени.ВГраница() Цикл
				Если ЭтоИсполняемоеПредставление
					...
					ИначеЕсли ЧастиИмени[Индекс] = "РегистрНакопления" Тогда
						Результат.Добавить("РегистрыНакопления");
					ИначеЕсли ЧастиИмени[Индекс] = "РегистрБухгалтерии" Тогда
						Результат.Добавить("РегистрыБухгалтерии");
