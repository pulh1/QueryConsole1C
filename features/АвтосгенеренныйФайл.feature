...
Сценарий: создание простого запроса
	...
	* Создание запроса получения данных
		...
		* Добавление ИсполняемоеПредставление.РегистрСведений.КадроваяИсторияСотрудников.Периоды
		...
		И Я устанавливаю агрегатрую функцию "СУММА" + для поля с выражением 'ДанныеУчетаВремениСотрудников.Дни'
		И Я устанавливаю агрегатрую функцию "СУММА" + для поля с выражением 'ДанныеУчетаВремениСотрудников.Часы'
