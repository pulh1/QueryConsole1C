...
Функционал: Создание запроса"ТестЗапросаНачисленияУдержания" в конструкторе
...
Контекст:
	...
	И я закрыл все окна клиентского приложения
Сценарий: создание запроса ТестЗапросаНачисленияУдержания
	...
	* Добавление ИсполняемоеПредставление.НачисленияУдержанияВыплаты
		...
		И Я присваиваю значение выражения 'Истина' параметру "ДетализироватьНачисленияПоСреднемуЗаработку" исполняемого представления
	...
	* Проверка результата создания запроса
		Тогда Текст запроса в консоли соответствует эталону "files/ТестЗапросаНачисленияУдержания.txt"
