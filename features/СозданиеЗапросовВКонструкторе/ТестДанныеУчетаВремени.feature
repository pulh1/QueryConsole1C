...
Функционал: Создание запроса"ТестДанныеУчетаВремени" в конструкторе
...
Контекст:
	...
	И я закрыл все окна клиентского приложения
Сценарий: создание запроса ТестДанныеУчетаВремени
	...
	* Проверка результа создания запроса
		Тогда Текст запроса в консоли соответствует эталону "files/ТестДанныеУчетаВремени.txt"
