...
Функционал: Создание запроса"ТестДанныеУчетаВремениСПараметрами" в конструкторе
...
Контекст:
	...
	И я закрыл все окна клиентского приложения
Сценарий: создание запроса ТестДанныеУчетаВремениСПараметрами
	...
	* Проверка результата создания запроса
		Тогда Текст запроса в консоли соответствует эталону "files/ТестДанныеУчетаВремениСПараметрами.txt"
