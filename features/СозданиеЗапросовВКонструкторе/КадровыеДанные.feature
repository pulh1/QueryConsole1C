...
Функционал: Создание запроса"КадровыеДанные" в конструкторе
...
Контекст:
	...
	И я закрыл все окна клиентского приложения
Сценарий: создание запроса КадровыеДанные
	...
	* Проверка результа создания запроса
		Тогда Текст запроса в консоли соответствует эталону "files/КадровыеДанные.txt"
