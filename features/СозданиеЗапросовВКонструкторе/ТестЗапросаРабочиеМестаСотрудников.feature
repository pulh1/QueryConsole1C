...
Функционал: Создание запроса"ТестЗапросаРабочиеМестаСотрудников" в конструкторе
...
Контекст:
	...
	И я закрыл все окна клиентского приложения
Сценарий: создание запроса ТестЗапросаРабочиеМестаСотрудников
	...
	* Проверка результа создания запроса
		Тогда Текст запроса в консоли соответствует эталону "files/ТестЗапросаРабочиеМестаСотрудников.txt"
