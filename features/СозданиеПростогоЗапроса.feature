...
Сценарий: создание простого запроса
	...
	* Вложенный запрос
	...
	И Я добавляю поле запроса "СотрудникиФизЛиц.ФизЛицо" в конструкторе запроса
	...
	И Я устанавливаю "Правое" соединение источника "Сотрудники" с источником "СотрудникиФизЛиц" по условию "Сотрудники.ФизическоеЛицо = СотрудникиФизЛиц.ФизЛицо"
