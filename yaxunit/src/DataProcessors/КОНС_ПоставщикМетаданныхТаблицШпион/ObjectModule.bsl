...
Перем ЭлементыКаталогаПоРодителям;
...
&НаСервере
Функция Настроить(
	ИмяПоставщика, Сегменты, Таблицы, НастройкаЭлементовКаталогаПоРодителям = Неопределено) Экспорт

	ИмяПоставщикаШпиона = ИмяПоставщика;
	СегментыПоставщика = Сегменты;
	СуществующиеТаблицы = Таблицы;
	ЭлементыКаталогаПоРодителям = НастройкаЭлементовКаталогаПоРодителям;
	Возврат ЭтотОбъект;

КонецФункции

// Возвращает элементы каталога для указанного родителя.
//
// Параметры:
//  ИдентификаторРодителя - Строка, Неопределено - Идентификатор узла или корень каталога.
//
// Возвращаемое значение:
//  Массив из Структура - Настроенные элементы каталога.
&НаСервере
