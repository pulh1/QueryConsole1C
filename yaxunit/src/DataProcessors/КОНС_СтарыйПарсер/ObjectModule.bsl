...
Процедура Инициализировать()
	ЛексическийАнализатор = Обработки.КОНС_СтарыйЛексическийАнализатор.Создать();
...
Функция НеТерминалПакетЗапросов(Родитель = Неопределено, ЛевыйЭлемент = Неопределено)
	...
	ЭтотУзел = КОНС_СтарыеЭлементыМоделиЗапроса.НовыйПакетЗапросов(ТекущийТокен);
...
Функция НеТерминалЗапросУничтожения(Родитель = Неопределено, ЛевыйЭлемент = Неопределено)
	...
	ЭтотУзел = Неопределено;
	ТекущийЭлемент = Неопределено;
	ЭтотУзел = КОНС_СтарыеЭлементыМоделиЗапроса.НовыйЗапросУничтожения(ТекущийТокен);
...
Функция НеТерминалЗапросВыбора(Родитель = Неопределено, ЛевыйЭлемент = Неопределено)
	...
	ЭтотУзел = Неопределено;
	ТекущийЭлемент = Неопределено;
	ЭтотУзел = КОНС_СтарыеЭлементыМоделиЗапроса.НовыйЗапросВыбора(ТекущийТокен);
...
Функция НеТерминалОбъединяемыйЗапрос(Родитель = Неопределено, ЛевыйЭлемент = Неопределено)
	...
	ЭтотУзел = Неопределено;
	ТекущийЭлемент = Неопределено;
	ЭтотУзел = КОНС_СтарыеЭлементыМоделиЗапроса.НовыйОператорЗапроса(ТекущийТокен);
...
Функция НеТерминалБлокОбъединить(Родитель = Неопределено, ЛевыйЭлемент = Неопределено)
	...
	Если НомерВариантаПродукции = 1 Тогда
		...
		Если ТекущийЭлемент <> "ПУСТО" Тогда
			ТипОбъединения = КОНС_СтарыеЭлементыМоделиЗапроса.НовыйТипОбъединение(ТекущийТокен);
		КонецЕсли;
...
Функция НеТерминалВсеОпционально(Родитель = Неопределено, ЛевыйЭлемент = Неопределено)
	...
	Если НомерВариантаПродукции = 1 Тогда
		ЭтотУзел = Неопределено;
		ТекущийЭлемент = Неопределено;
		ЭтотУзел = КОНС_СтарыеЭлементыМоделиЗапроса.НовыйТипОбъединениеВсе(ТекущийТокен);
...
Функция НеТерминалПоляВыборки(Родитель = Неопределено, ЛевыйЭлемент = Неопределено)
	...
	ЭтотУзел = Неопределено;
	ТекущийЭлемент = Неопределено;
	ЭтотУзел = КОНС_СтарыеЭлементыМоделиЗапроса.НовыйВыбираемыеПоля(ТекущийТокен);
...
Функция НеТерминалПолеВыборки(Родитель = Неопределено, ЛевыйЭлемент = Неопределено)
	...
	Если НомерВариантаПродукции = 1 Тогда
		ЭтотУзел = Неопределено;
		ТекущийЭлемент = Неопределено;
		ЭтотУзел = КОНС_СтарыеЭлементыМоделиЗапроса.НовыйПолеЗапроса(ТекущийТокен);
	...
	ИначеЕсли НомерВариантаПродукции = 2 Тогда
		...
		ТекущийЭлемент = Лексема("*");
		Если ТекущийЭлемент <> "ПУСТО" Тогда
			ЭтотУзел.Выражение = КОНС_СтарыеЭлементыМоделиЗапроса.НовыйВыражениеМоделиЗапроса(ТекущийТокен);
			ЭтотУзел.Выражение.Значение = КОНС_СтарыеЭлементыМоделиЗапроса.НовыйВыражениеВсеПоля(ТекущийТокен);
		КонецЕсли;
	Иначе
...
Функция НеТерминалБлокИз(Родитель = Неопределено, ЛевыйЭлемент = Неопределено)
	...
	Если НомерВариантаПродукции = 1 Тогда
		ЭтотУзел = Неопределено;
		ТекущийЭлемент = Неопределено;
		ЭтотУзел = КОНС_СтарыеЭлементыМоделиЗапроса.НовыйИсточникиЗапроса(ТекущийТокен);
...
Функция НеТерминалИсточникДанныхЗапроса(Родитель = Неопределено, ЛевыйЭлемент = Неопределено, Источники = Неопределено)
	...
	ЭтотУзел = Неопределено;
	ТекущийЭлемент = Неопределено;
	ЭтотУзел = КОНС_СтарыеЭлементыМоделиЗапроса.НовыйИсточник(ТекущийТокен);
...
Функция НеТерминалПраваяЧастьСоединения(Родитель = Неопределено, ЛевыйЭлемент = Неопределено, Источники = Неопределено)
	...
	ЭтотУзел = Неопределено;
	ТекущийЭлемент = Неопределено;
	ЭтотУзел = КОНС_СтарыеЭлементыМоделиЗапроса.НовыйСоединениеИсточника(ТекущийТокен);
...
Функция НеТерминалТипСоединения(Родитель = Неопределено, ЛевыйЭлемент = Неопределено)
	...
	Если НомерВариантаПродукции = 1 Тогда
		ЭтотУзел = Неопределено;
		ТекущийЭлемент = Неопределено;
		ЭтотУзел = КОНС_СтарыеЭлементыМоделиЗапроса.НовыйТипСоединенияЛевое(ТекущийТокен);
		ТекущийЭлемент = Терминал("ЛЕВОЕ");
	ИначеЕсли НомерВариантаПродукции = 2 Тогда
		ЭтотУзел = Неопределено;
		ТекущийЭлемент = Неопределено;
		ЭтотУзел = КОНС_СтарыеЭлементыМоделиЗапроса.НовыйТипСоединенияПравое(ТекущийТокен);
		ТекущийЭлемент = Терминал("ПРАВОЕ");
	ИначеЕсли НомерВариантаПродукции = 3 Тогда
		ЭтотУзел = Неопределено;
		ТекущийЭлемент = Неопределено;
		ЭтотУзел = КОНС_СтарыеЭлементыМоделиЗапроса.НовыйТипСоединенияВнутреннее(ТекущийТокен);
		ТекущийЭлемент = Терминал("ВНУТРЕННЕЕ");
	ИначеЕсли НомерВариантаПродукции = 4 Тогда
		ЭтотУзел = Неопределено;
		ТекущийЭлемент = Неопределено;
		ЭтотУзел = КОНС_СтарыеЭлементыМоделиЗапроса.НовыйТипСоединенияПолное(ТекущийТокен);
...
Функция НеТерминалИсточникДанныхТаблицаЗначений(Родитель = Неопределено, ЛевыйЭлемент = Неопределено)
	...
	ЭтотУзел = Неопределено;
	ТекущийЭлемент = Неопределено;
	ЭтотУзел = КОНС_СтарыеЭлементыМоделиЗапроса.НовыйИсточникДанныхТаблицаЗначений(ТекущийТокен);
...
Функция НеТерминалИсточникДанныхВременнаяТаблица(Родитель = Неопределено, ЛевыйЭлемент = Неопределено)
	...
	ЭтотУзел = Неопределено;
	ТекущийЭлемент = Неопределено;
	ЭтотУзел = КОНС_СтарыеЭлементыМоделиЗапроса.НовыйИсточникДанныхВременнаяТаблица(ТекущийТокен);
	ТекущийЭлемент = Идентификатор("ID_ИмяТаблицы");
	Если ТекущийЭлемент <> "ПУСТО" Тогда
		ЭтотУзел.ИмяТаблицы = ТекущийЭлемент;
	КонецЕсли;
...
Функция НеТерминалИсточникДанныхТаблица(Родитель = Неопределено, ЛевыйЭлемент = Неопределено)
	...
	ЭтотУзел = Неопределено;
	ТекущийЭлемент = Неопределено;
	ЭтотУзел = КОНС_СтарыеЭлементыМоделиЗапроса.НовыйИсточникДанныхТаблица(ТекущийТокен);
	ТекущийЭлемент = Идентификатор("ID_ИмяТаблицы");
	Если ТекущийЭлемент <> "ПУСТО" Тогда
		ЭтотУзел.ИмяТаблицы = ТекущийЭлемент;
	КонецЕсли;
...
Функция НеТерминалИсточникДанныхВложенныйЗапрос(Родитель = Неопределено, ЛевыйЭлемент = Неопределено)
	...
	ЭтотУзел = Неопределено;
	ТекущийЭлемент = Неопределено;
	ЭтотУзел = КОНС_СтарыеЭлементыМоделиЗапроса.НовыйИсточникДанныхВложенныйЗапрос(ТекущийТокен);
	ТекущийЭлемент = Лексема("(");
	ТекущийЭлемент = НеТерминалЗапросВыбора(ЭтотУзел, ТекущийЭлемент);
	Если ТекущийЭлемент <> "ПУСТО" Тогда
...
Функция НеТерминалСписокПараметров(Родитель = Неопределено, ЛевыйЭлемент = Неопределено)
	...
	ЭтотУзел = Неопределено;
	ТекущийЭлемент = Неопределено;
	ЭтотУзел = КОНС_СтарыеЭлементыМоделиЗапроса.НовыйСписокПараметров(ТекущийТокен);
...
Функция НеТерминалСписокЭлементовУпорядочивания(Родитель = Неопределено, ЛевыйЭлемент = Неопределено)
	...
	ЭтотУзел = Неопределено;
	ТекущийЭлемент = Неопределено;
	ЭтотУзел = КОНС_СтарыеЭлементыМоделиЗапроса.НовыйЭлементыПорядка(ТекущийТокен);
...
Функция НеТерминалЭлементУпорядочивания(Родитель = Неопределено, ЛевыйЭлемент = Неопределено)
	...
	ЭтотУзел = Неопределено;
	ТекущийЭлемент = Неопределено;
	ЭтотУзел = КОНС_СтарыеЭлементыМоделиЗапроса.НовыйЭлементПорядка(ТекущийТокен);
	ТекущийЭлемент = НеТерминалВыражениеМоделиЗапроса(ЭтотУзел, ТекущийЭлемент);
	Если ТекущийЭлемент <> "ПУСТО" Тогда
		ЭтотУзел.Выражение = ТекущийЭлемент;
	КонецЕсли;
...
Функция НеТерминалНаправлениеУпорядочивания(Родитель = Неопределено, ЛевыйЭлемент = Неопределено)
	...
	Если НомерВариантаПродукции = 1 Тогда
		ЭтотУзел = Неопределено;
		ТекущийЭлемент = Неопределено;
		ЭтотУзел = КОНС_СтарыеЭлементыМоделиЗапроса.НовыйНаправлениеВозрастание(ТекущийТокен);
	...
	ИначеЕсли НомерВариантаПродукции = 2 Тогда
		...
		Если ТекущийЭлемент <> "ПУСТО" Тогда
			ЭтотУзел = КОНС_СтарыеЭлементыМоделиЗапроса.НовыйНаправлениеУбывание(ТекущийТокен);
		КонецЕсли;
	КонецЕсли;
...
Функция НеТерминалПоляИтогов(Родитель = Неопределено, ЛевыйЭлемент = Неопределено)
	...
	Если НомерВариантаПродукции = 1 Тогда
		ЭтотУзел = Неопределено;
		ТекущийЭлемент = Неопределено;
		ЭтотУзел = КОНС_СтарыеЭлементыМоделиЗапроса.НовыйВыраженияИтогов(ТекущийТокен);
		ТекущийЭлемент = НеТерминалПолеВыборки(ЭтотУзел, ТекущийЭлемент);
		Если ТекущийЭлемент <> "ПУСТО" Тогда
			ЭтотУзел.Добавить(ТекущийЭлемент);
		КонецЕсли;
...
Функция НеТерминалКонтрольныеТочкиИтогов(Родитель = Неопределено, ЛевыйЭлемент = Неопределено)
	...
	ЭтотУзел = Неопределено;
	ТекущийЭлемент = Неопределено;
	ЭтотУзел = КОНС_СтарыеЭлементыМоделиЗапроса.НовыйКонтрольныеТочкиИтогов(ТекущийТокен);
...
Функция НеТерминалКонтрольнаяТочкаИтогов(Родитель = Неопределено, ЛевыйЭлемент = Неопределено)
	...
	Если НомерВариантаПродукции = 1 Тогда
		ЭтотУзел = Неопределено;
		ТекущийЭлемент = Неопределено;
		ЭтотУзел = КОНС_СтарыеЭлементыМоделиЗапроса.НовыйКонтрольнаяТочкаИтогов(ТекущийТокен);
		ТекущийЭлемент = НеТерминалВыражениеМоделиЗапроса(ЭтотУзел, ТекущийЭлемент);
		Если ТекущийЭлемент <> "ПУСТО" Тогда
			ЭтотУзел.Выражение = ТекущийЭлемент;
		КонецЕсли;
	...
	ИначеЕсли НомерВариантаПродукции = 2 Тогда
		ЭтотУзел = Неопределено;
		ТекущийЭлемент = Неопределено;
		ЭтотУзел = КОНС_СтарыеЭлементыМоделиЗапроса.НовыйОбщиеИтоги(ТекущийТокен);
...
Функция НеТерминалТипКонтрольнойТочки(Родитель = Неопределено, ЛевыйЭлемент = Неопределено)
	...
	Если НомерВариантаПродукции = 1 Тогда
		ЭтотУзел = Неопределено;
		ТекущийЭлемент = Неопределено;
		ЭтотУзел = КОНС_СтарыеЭлементыМоделиЗапроса.НовыйТипКонтрольнойТочкиТолькоИерархия(ТекущийТокен);
		ТекущийЭлемент = Терминал("ТОЛЬКО");
		ТекущийЭлемент = Терминал("ИЕРАРХИЯ");
	ИначеЕсли НомерВариантаПродукции = 2 Тогда
		ЭтотУзел = Неопределено;
		ТекущийЭлемент = Неопределено;
		ЭтотУзел = КОНС_СтарыеЭлементыМоделиЗапроса.НовыйТипКонтрольнойТочкиИерархия(ТекущийТокен);
		ТекущийЭлемент = Терминал("ИЕРАРХИЯ");
	КонецЕсли;
...
Функция НеТерминалЛогическоеИли(Родитель = Неопределено, ЛевыйЭлемент = Неопределено)
	...
	Если НомерВариантаПродукции = 1 Тогда
		ЭтотУзел = Неопределено;
		ТекущийЭлемент = Неопределено;
		ЭтотУзел = КОНС_СтарыеЭлементыМоделиЗапроса.НовыйБинарнаяОперация(ТекущийТокен);
...
Функция НеТерминалЛогическийОператор(Родитель = Неопределено, ЛевыйЭлемент = Неопределено)
	...
	Если НомерВариантаПродукции = 1 Тогда
		ЭтотУзел = Неопределено;
		ТекущийЭлемент = Неопределено;
		ЭтотУзел = КОНС_СтарыеЭлементыМоделиЗапроса.НовыйОператорМежду(ТекущийТокен);
	...
	ИначеЕсли НомерВариантаПродукции = 2 Тогда
		ЭтотУзел = Неопределено;
		ТекущийЭлемент = Неопределено;
		ЭтотУзел = КОНС_СтарыеЭлементыМоделиЗапроса.НовыйОператорПроверкиТипа(ТекущийТокен);
		ЭтотУзел.Операнд = ЛевыйЭлемент;
	...
	ИначеЕсли НомерВариантаПродукции = 3 Тогда
		ЭтотУзел = Неопределено;
		ТекущийЭлемент = Неопределено;
		ЭтотУзел = КОНС_СтарыеЭлементыМоделиЗапроса.НовыйОператорПроверкиНаNULL(ТекущийТокен);
		ЭтотУзел.Операнд = ЛевыйЭлемент;
	...
	ИначеЕсли НомерВариантаПродукции = 4 Тогда
		ЭтотУзел = Неопределено;
		ТекущийЭлемент = Неопределено;
		ЭтотУзел = КОНС_СтарыеЭлементыМоделиЗапроса.НовыйОператорВ(ТекущийТокен);
		ЭтотУзел.Операнд = ЛевыйЭлемент;
		ТекущийЭлемент = НеТерминалОпциональноеНЕ(ЭтотУзел, ТекущийЭлемент);
		Если ТекущийЭлемент <> "ПУСТО" Тогда
			ЭтотУзел.Инверсия = Истина;
...
Функция НеТерминалТипСсылочногоПоля(Родитель = Неопределено, ЛевыйЭлемент = Неопределено)
	...
	ЭтотУзел = Неопределено;
	ТекущийЭлемент = Неопределено;
	ЭтотУзел = КОНС_СтарыеЭлементыМоделиЗапроса.НовыйТипСсылочногоПоля(ТекущийТокен);
	;
	ТекущийЭлемент = Идентификатор("ID_Полный");
	Если ТекущийЭлемент <> "ПУСТО" Тогда
...
Функция НеТерминалОтрицание(Родитель = Неопределено, ЛевыйЭлемент = Неопределено)
	...
	ЭтотУзел = Неопределено;
	ТекущийЭлемент = Неопределено;
	ЭтотУзел = КОНС_СтарыеЭлементыМоделиЗапроса.НовыйЛогическоеОтрицание(ТекущийТокен);
...
Функция НеТерминалОператорПодобно(Родитель = Неопределено, ЛевыйЭлемент = Неопределено)
	...
	Если НомерВариантаПродукции = 1 Тогда
		ЭтотУзел = Неопределено;
		ТекущийЭлемент = Неопределено;
		ЭтотУзел = КОНС_СтарыеЭлементыМоделиЗапроса.НовыйОператорПодобно(ТекущийТокен);
		ЭтотУзел.Операнд = ЛевыйЭлемент;
		ТекущийЭлемент = НеТерминалОпциональноеНЕ(ЭтотУзел, ТекущийЭлемент);
		Если ТекущийЭлемент <> "ПУСТО" Тогда
			ЭтотУзел.Инверсия = Истина;
...
Функция НеТерминалШаблонПодобия(Родитель = Неопределено, ЛевыйЭлемент = Неопределено)
	...
	Если НомерВариантаПродукции = 1 Тогда
		ЭтотУзел = Неопределено;
		ТекущийЭлемент = Неопределено;
		ЭтотУзел = КОНС_СтарыеЭлементыМоделиЗапроса.НовыйКонстанта(ТекущийТокен);
...
Функция НеТерминалУнарнаяОперация(Родитель = Неопределено, ЛевыйЭлемент = Неопределено)
	...
	ЭтотУзел = Неопределено;
	ТекущийЭлемент = Неопределено;
	ЭтотУзел = КОНС_СтарыеЭлементыМоделиЗапроса.НовыйУнарнаяОперация(ТекущийТокен);
...
Функция НеТерминалПоле(Родитель = Неопределено, ЛевыйЭлемент = Неопределено)
	...
	Если НомерВариантаПродукции = 1 Тогда
		ЭтотУзел = Неопределено;
		ТекущийЭлемент = Неопределено;
		ЭтотУзел = КОНС_СтарыеЭлементыМоделиЗапроса.НовыйРазыменование(ТекущийТокен);
		ТекущийЭлемент = Идентификатор("ID_ПсевдонимРасширенный");
		Если ТекущийЭлемент <> "ПУСТО" Тогда
			ЭтотУзел.Элементы.Добавить(ТекущийЭлемент);
		КонецЕсли;
	...
	ИначеЕсли НомерВариантаПродукции = 3 Тогда
		...
		Если ТекущийЭлемент <> "ПУСТО" Тогда
			ЭтотУзел = ТекущийЭлемент;
			Разыменование = КОНС_СтарыеЭлементыМоделиЗапроса.НовыйРазыменование(ТекущийТокен);
...
Функция НеТерминалОперацияРазыменования(Родитель = Неопределено, ЛевыйЭлемент = Неопределено, Элементы = Неопределено)
	...
	ИначеЕсли НомерВариантаПродукции = 3 Тогда
		...
		ТекущийЭлемент = Лексема("*");
		Если ТекущийЭлемент <> "ПУСТО" Тогда
			ТекущийЭлемент = КОНС_СтарыеЭлементыМоделиЗапроса.НовыйВыражениеВсеПоляИсточника(ТекущийТокен);
			Элементы.Добавить(ТекущийЭлемент);
		КонецЕсли;
	ИначеЕсли НомерВариантаПродукции = 4 Тогда
		ЭтотУзел = Неопределено;
		ТекущийЭлемент = Неопределено;
		ЭтотУзел = КОНС_СтарыеЭлементыМоделиЗапроса.НовыйПоляВложеннойТаблицы(ТекущийТокен);
...
Функция НеТерминалСписокВыражений(Родитель = Неопределено, ЛевыйЭлемент = Неопределено)
	...
	ЭтотУзел = Неопределено;
	ТекущийЭлемент = Неопределено;
	ЭтотУзел = КОНС_СтарыеЭлементыМоделиЗапроса.НовыйСписокВыражений(ТекущийТокен);
	ТекущийЭлемент = НеТерминалВыражение(ЭтотУзел, ТекущийЭлемент);
	Если ТекущийЭлемент <> "ПУСТО" Тогда
		ЭтотУзел.Элементы.Добавить(ТекущийЭлемент);
	КонецЕсли;
...
Функция НеТерминалВыражениеМоделиЗапроса(Родитель = Неопределено, ЛевыйЭлемент = Неопределено)
	...
	ЭтотУзел = Неопределено;
	ТекущийЭлемент = Неопределено;
	ЭтотУзел = КОНС_СтарыеЭлементыМоделиЗапроса.НовыйВыражениеМоделиЗапроса(ТекущийТокен);
	ТекущийЭлемент = НеТерминалВыражение(ЭтотУзел, ТекущийЭлемент);
	Если ТекущийЭлемент <> "ПУСТО" Тогда
		ЭтотУзел.Значение = ТекущийЭлемент;
	КонецЕсли;
...
Функция НеТерминалПриведениеТипа(Родитель = Неопределено, ЛевыйЭлемент = Неопределено)
	...
	ЭтотУзел = Неопределено;
	ТекущийЭлемент = Неопределено;
	ЭтотУзел = КОНС_СтарыеЭлементыМоделиЗапроса.НовыйПриведениеТипа(ТекущийТокен);
...
Функция НеТерминалОписаниеТипа(Родитель = Неопределено, ЛевыйЭлемент = Неопределено)
	...
	ИначеЕсли НомерВариантаПродукции = 2 Тогда
		ЭтотУзел = Неопределено;
		ТекущийЭлемент = Неопределено;
		ЭтотУзел = КОНС_СтарыеЭлементыМоделиЗапроса.НовыйОписаниеТипаБулево(ТекущийТокен);
		ТекущийЭлемент = Терминал("БУЛЕВО");
	ИначеЕсли НомерВариантаПродукции = 3 Тогда
		ЭтотУзел = Неопределено;
		ТекущийЭлемент = Неопределено;
		ЭтотУзел = КОНС_СтарыеЭлементыМоделиЗапроса.НовыйОписаниеТипаДата(ТекущийТокен);
		ТекущийЭлемент = Терминал("ДАТА");
	ИначеЕсли НомерВариантаПродукции = 4 Тогда
		ЭтотУзел = Неопределено;
		ТекущийЭлемент = Неопределено;
		ЭтотУзел = КОНС_СтарыеЭлементыМоделиЗапроса.НовыйОписаниеТипаЧисло(ТекущийТокен);
		ТекущийЭлемент = Терминал("ЧИСЛО");
		ТекущийЭлемент = НеТерминалОписаниеЧисла(ЭтотУзел, ТекущийЭлемент);
	ИначеЕсли НомерВариантаПродукции = 5 Тогда
		ЭтотУзел = Неопределено;
		ТекущийЭлемент = Неопределено;
		ЭтотУзел = КОНС_СтарыеЭлементыМоделиЗапроса.НовыйОписаниеТипаСтрока(ТекущийТокен);
...
Функция НеТерминалВыбор(Родитель = Неопределено, ЛевыйЭлемент = Неопределено)
	...
	ЭтотУзел = Неопределено;
	ТекущийЭлемент = Неопределено;
	ЭтотУзел = КОНС_СтарыеЭлементыМоделиЗапроса.НовыйВыбор(ТекущийТокен);
...
Функция НеТерминалАльтернативыВыбора(Родитель = Неопределено, ЛевыйЭлемент = Неопределено)
	...
	ЭтотУзел = Неопределено;
	ТекущийЭлемент = Неопределено;
	ЭтотУзел = КОНС_СтарыеЭлементыМоделиЗапроса.НовыйАльтернативыВыбора(ТекущийТокен);
...
Функция НеТерминалКогдаТогда(Родитель = Неопределено, ЛевыйЭлемент = Неопределено)
	...
	ЭтотУзел = Неопределено;
	ТекущийЭлемент = Неопределено;
	ЭтотУзел = КОНС_СтарыеЭлементыМоделиЗапроса.НовыйАльтернативаВыбора(ТекущийТокен);
...
Функция НеТерминалПараметр(Родитель = Неопределено, ЛевыйЭлемент = Неопределено)
	...
	ЭтотУзел = Неопределено;
	ТекущийЭлемент = Неопределено;
	ЭтотУзел = КОНС_СтарыеЭлементыМоделиЗапроса.НовыйПараметрЗапроса(ТекущийТокен);
	ТекущийЭлемент = Лексема("&");
	ТекущийЭлемент = Идентификатор("ID_Полный");
	Если ТекущийЭлемент <> "ПУСТО" Тогда
...
Функция НеТерминалАгрегатнаяФункция(Родитель = Неопределено, ЛевыйЭлемент = Неопределено)
	...
	Если НомерВариантаПродукции = 1 Тогда
		ЭтотУзел = Неопределено;
		ТекущийЭлемент = Неопределено;
		ЭтотУзел = КОНС_СтарыеЭлементыМоделиЗапроса.НовыйАгрегатнаяФункция(ТекущийТокен);
	...
	ИначеЕсли НомерВариантаПродукции = 5 Тогда
		ЭтотУзел = Неопределено;
		ТекущийЭлемент = Неопределено;
		ЭтотУзел = КОНС_СтарыеЭлементыМоделиЗапроса.НовыйАгрегатнаяФункцияКоличество(ТекущийТокен);
...
Функция НеТерминалФункция(Родитель = Неопределено, ЛевыйЭлемент = Неопределено)
	...
	Если НомерВариантаПродукции = 1 Тогда
		ЭтотУзел = Неопределено;
		ТекущийЭлемент = Неопределено;
		ЭтотУзел = КОНС_СтарыеЭлементыМоделиЗапроса.НовыйФункцияПодстрока(ТекущийТокен);
	...
	ИначеЕсли НомерВариантаПродукции = 2 Тогда
		ЭтотУзел = Неопределено;
		ТекущийЭлемент = Неопределено;
		ЭтотУзел = КОНС_СтарыеЭлементыМоделиЗапроса.НовыйФункцияГод(ТекущийТокен);
		ТекущийЭлемент = Терминал("ГОД");
		ТекущийЭлемент = Лексема("(");
		ТекущийЭлемент = НеТерминалВыражение(ЭтотУзел, ТекущийЭлемент);
		Если ТекущийЭлемент <> "ПУСТО" Тогда
	...
	ИначеЕсли НомерВариантаПродукции = 3 Тогда
		ЭтотУзел = Неопределено;
		ТекущийЭлемент = Неопределено;
		ЭтотУзел = КОНС_СтарыеЭлементыМоделиЗапроса.НовыйФункцияКвартал(ТекущийТокен);
	...
	ИначеЕсли НомерВариантаПродукции = 4 Тогда
		ЭтотУзел = Неопределено;
		ТекущийЭлемент = Неопределено;
		ЭтотУзел = КОНС_СтарыеЭлементыМоделиЗапроса.НовыйФункцияМесяц(ТекущийТокен);
		ТекущийЭлемент = Терминал("МЕСЯЦ");
		ТекущийЭлемент = Лексема("(");
		ТекущийЭлемент = НеТерминалВыражение(ЭтотУзел, ТекущийЭлемент);
		Если ТекущийЭлемент <> "ПУСТО" Тогда
	...
	ИначеЕсли НомерВариантаПродукции = 5 Тогда
		ЭтотУзел = Неопределено;
		ТекущийЭлемент = Неопределено;
		ЭтотУзел = КОНС_СтарыеЭлементыМоделиЗапроса.НовыйФункцияДеньГода(ТекущийТокен);
	...
	ИначеЕсли НомерВариантаПродукции = 6 Тогда
		ЭтотУзел = Неопределено;
		ТекущийЭлемент = Неопределено;
		ЭтотУзел = КОНС_СтарыеЭлементыМоделиЗапроса.НовыйФункцияДень(ТекущийТокен);
		ТекущийЭлемент = Терминал("ДЕНЬ");
		ТекущийЭлемент = Лексема("(");
		ТекущийЭлемент = НеТерминалВыражение(ЭтотУзел, ТекущийЭлемент);
		Если ТекущийЭлемент <> "ПУСТО" Тогда
	...
	ИначеЕсли НомерВариантаПродукции = 7 Тогда
		ЭтотУзел = Неопределено;
		ТекущийЭлемент = Неопределено;
		ЭтотУзел = КОНС_СтарыеЭлементыМоделиЗапроса.НовыйФункцияДеньМесяца(ТекущийТокен);
		ТекущийЭлемент = Терминал("НЕДЕЛЯ");
		ТекущийЭлемент = Лексема("(");
		ТекущийЭлемент = НеТерминалВыражение(ЭтотУзел, ТекущийЭлемент);
		Если ТекущийЭлемент <> "ПУСТО" Тогда
	...
	ИначеЕсли НомерВариантаПродукции = 8 Тогда
		ЭтотУзел = Неопределено;
		ТекущийЭлемент = Неопределено;
		ЭтотУзел = КОНС_СтарыеЭлементыМоделиЗапроса.НовыйФункцияДеньНедели(ТекущийТокен);
	...
	ИначеЕсли НомерВариантаПродукции = 9 Тогда
		ЭтотУзел = Неопределено;
		ТекущийЭлемент = Неопределено;
		ЭтотУзел = КОНС_СтарыеЭлементыМоделиЗапроса.НовыйФункцияЧас(ТекущийТокен);
		ТекущийЭлемент = Терминал("ЧАС");
		ТекущийЭлемент = Лексема("(");
		ТекущийЭлемент = НеТерминалВыражение(ЭтотУзел, ТекущийЭлемент);
		Если ТекущийЭлемент <> "ПУСТО" Тогда
	...
	ИначеЕсли НомерВариантаПродукции = 10 Тогда
		ЭтотУзел = Неопределено;
		ТекущийЭлемент = Неопределено;
		ЭтотУзел = КОНС_СтарыеЭлементыМоделиЗапроса.НовыйФункцияМинута(ТекущийТокен);
		ТекущийЭлемент = Терминал("МИНУТА");
		ТекущийЭлемент = Лексема("(");
		ТекущийЭлемент = НеТерминалВыражение(ЭтотУзел, ТекущийЭлемент);
		Если ТекущийЭлемент <> "ПУСТО" Тогда
	...
	ИначеЕсли НомерВариантаПродукции = 11 Тогда
		ЭтотУзел = Неопределено;
		ТекущийЭлемент = Неопределено;
		ЭтотУзел = КОНС_СтарыеЭлементыМоделиЗапроса.НовыйФункцияСекунда(ТекущийТокен);
		ТекущийЭлемент = Терминал("СЕКУНДА");
		ТекущийЭлемент = Лексема("(");
		ТекущийЭлемент = НеТерминалВыражение(ЭтотУзел, ТекущийЭлемент);
		Если ТекущийЭлемент <> "ПУСТО" Тогда
	...
	ИначеЕсли НомерВариантаПродукции = 12 Тогда
		ЭтотУзел = Неопределено;
		ТекущийЭлемент = Неопределено;
		ЭтотУзел = КОНС_СтарыеЭлементыМоделиЗапроса.НовыйФункцияНачалоПериода(ТекущийТокен);
	...
	ИначеЕсли НомерВариантаПродукции = 13 Тогда
		ЭтотУзел = Неопределено;
		ТекущийЭлемент = Неопределено;
		ЭтотУзел = КОНС_СтарыеЭлементыМоделиЗапроса.НовыйФункцияКонецПериода(ТекущийТокен);
	...
	ИначеЕсли НомерВариантаПродукции = 14 Тогда
		ЭтотУзел = Неопределено;
		ТекущийЭлемент = Неопределено;
		ЭтотУзел = КОНС_СтарыеЭлементыМоделиЗапроса.НовыйФункцияДобавитьКДате(ТекущийТокен);
	...
	ИначеЕсли НомерВариантаПродукции = 15 Тогда
		ЭтотУзел = Неопределено;
		ТекущийЭлемент = Неопределено;
		ЭтотУзел = КОНС_СтарыеЭлементыМоделиЗапроса.НовыйФункцияРазностьДат(ТекущийТокен);
	...
	ИначеЕсли НомерВариантаПродукции = 16 Тогда
		ЭтотУзел = Неопределено;
		ТекущийЭлемент = Неопределено;
		ЭтотУзел = КОНС_СтарыеЭлементыМоделиЗапроса.НовыйФункцияIsNull(ТекущийТокен);
	...
	ИначеЕсли НомерВариантаПродукции = 17 Тогда
		ЭтотУзел = Неопределено;
		ТекущийЭлемент = Неопределено;
		ЭтотУзел = КОНС_СтарыеЭлементыМоделиЗапроса.НовыйФункцияПредставление(ТекущийТокен);
	...
	ИначеЕсли НомерВариантаПродукции = 18 Тогда
		ЭтотУзел = Неопределено;
		ТекущийЭлемент = Неопределено;
		ЭтотУзел = КОНС_СтарыеЭлементыМоделиЗапроса.НовыйФункцияПредставлениеСсылки(ТекущийТокен);
	...
	ИначеЕсли НомерВариантаПродукции = 19 Тогда
		ЭтотУзел = Неопределено;
		ТекущийЭлемент = Неопределено;
		ЭтотУзел = КОНС_СтарыеЭлементыМоделиЗапроса.НовыйФункцияТипЗначения(ТекущийТокен);
	...
	ИначеЕсли НомерВариантаПродукции = 20 Тогда
		ЭтотУзел = Неопределено;
		ТекущийЭлемент = Неопределено;
		ЭтотУзел = КОНС_СтарыеЭлементыМоделиЗапроса.НовыйФункцияДатаВремя(ТекущийТокен);
	...
	ИначеЕсли НомерВариантаПродукции = 21 Тогда
		ЭтотУзел = Неопределено;
		ТекущийЭлемент = Неопределено;
		ЭтотУзел = КОНС_СтарыеЭлементыМоделиЗапроса.НовыйФункцияЗначение(ТекущийТокен);
	...
	ИначеЕсли НомерВариантаПродукции = 22 Тогда
		ЭтотУзел = Неопределено;
		ТекущийЭлемент = Неопределено;
		ЭтотУзел = КОНС_СтарыеЭлементыМоделиЗапроса.НовыйФункцияТип(ТекущийТокен);
